...
### How to use it?
1. [Build this mod](https://docs.fabricmc.net/develop/getting-started/building-a-mod) using JDK 17.
...
4. Make sure the model you want to export is loaded in-game.
     1. If it's not, run `/cpmclient set_model <file_name>` (the model has to be located at `[minecraft's directory]/player_models`). If your model is stored in your skin, make sure your skin loads properly, etc.
...
4. The code no longer uses deprecated features (such as `ModelPartDefinition`).
